...
import 'package:ktracer_center/widgets/device_details/tests/tests.dart';
...
class _DeviceDetailsState extends State<DeviceDetails> {
  ...
  Widget build(BuildContext context) {
    final noColor = WidgetStateColor.resolveWith(
    ...
    return TabView(
      ...
      tabs: [
        ...
        Tab(
          text: const Text('Tests'),
          body: TestsTab(device: widget.device),
          backgroundColor: noColor,
          selectedBackgroundColor: noColor,
        ),
        Tab(
