...
class _TunnelManagementState extends State<TunnelManagement> {
  ...
  Future<void> _updateTunnelField(String field, dynamic value) async {
    ...
    final tunnelJson = tunnels[widget.tunnelIndex].toJson();
    tunnelJson[field] = value;
  ...
  Widget _buildGreFields(TunnelConfig tunnel) {
    return Column(
      ...
      children: [
                  ...
                  builder: (context) => ContentDialog(
                    ...
                    content: SizedBox(
                      ...
                      child: InterfaceSelector(
                        ...
                        filter: InterfaceFilter(requireIpAddress: true),
                      ),
                    ),
                    actions: [
                      Button(
        ...
        const SizedBox(height: 4),
        IpAddressField(
          controller: _tunnelDestinationController,
