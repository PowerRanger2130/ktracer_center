    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile.selectable(
          ...
          subtitle: showIpAddress && iface.ipAddress != null
              ? Text(iface.ipAddress!.toCIDR())
              : null,
        ...
        return ToggleButton(
          ...
          child: Row(
            ...
            children: [
              ...
              if (showIpAddress && iface.ipAddress != null) ...[
                const SizedBox(width: 4),
                Text(
                  '(${iface.networkCidr})',
        ...
        Expanded(
          child: Row(
            ...
            children: [
              ...
              if (showIpAddress && iface.networkCidr != null)
                Text(
                  iface.networkCidr!,
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            if (showIpAddress && interface_.ipAddress != null)
              Text(
