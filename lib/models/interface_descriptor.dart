...
class InterfaceDescriptor {
  ...
  /// IPv4 assignment mode for physical/subinterfaces
  ...
  factory InterfaceDescriptor.fromPort(Port port, int index) {
    ...
    return InterfaceDescriptor(
      ...
      ipAssignment: port.ipAssignment,
  ...
  /// Check if this interface is configured to receive IPv4 via DHCP
  bool get usesDhcpForIpv4 => ipAssignment == IpAssignmentMode.dhcp;

  /// Check if this interface can act as an IPv4 endpoint via static IP or DHCP
  bool get hasIpv4OrDhcp => hasIpAddress || usesDhcpForIpv4;
...
class InterfaceFilter {
  ...
  /// Only include interfaces with a static IPv4 or DHCP-assigned IPv4
  final bool requireIpv4OrDhcp;
  ...
  /// Filter that only shows interfaces that can provide IPv4 via static IP or DHCP
  static const ipv4OrDhcp = InterfaceFilter(requireIpv4OrDhcp: true);
  ...
  bool matches(InterfaceDescriptor iface) {
    ...
    if (requireIpv4OrDhcp && !iface.hasIpv4OrDhcp) return false;
  ...
  InterfaceFilter copyWith({
    ...
    return InterfaceFilter(
      ...
      requireIpv4OrDhcp: requireIpv4OrDhcp ?? this.requireIpv4OrDhcp,
