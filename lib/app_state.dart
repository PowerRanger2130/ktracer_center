...
class AppState extends ChangeNotifier {
  ...
  ConnectionStatus get grpcStatus => _grpcStatus;
  ConnectionStatus get supabaseStatus => _supabaseStatus;
  String? get grpcError => _grpcError;
  String? get supabaseError => _supabaseError;

  /// Whether the gRPC client is connected
  bool get isGrpcConnected => _grpcStatus == ConnectionStatus.connected;
  ...
  void _subscribeToProjectChanges() {
    final channel = Supabase.instance.client.channel('projects-changes');
  ...
  void _scheduleGrpcReconnect() {
    ...
    _grpcReconnectTimer = Timer(const Duration(seconds: 10), () {
      if (_grpcStatus != ConnectionStatus.connected) {
