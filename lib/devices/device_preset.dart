...
class DevicePresets {
  ...
  static final i4221 = DevicePreset(
    id: 17,
    name: 'ISR 4221',
    sku: 'ISR 4221',
    category: NetDeviceCategory.Router,
    color: const Color.fromARGB(80, 255, 152, 0),
    hasSsh: true,
    etherchannelLimit: 0,
    defaultInterfaces: () => [
  ...
  static final c8200l = DevicePreset(
    id: 16,
    name: 'Edge 8200L',
    sku: 'C8200L',
    category: NetDeviceCategory.Router,
    color: const Color.fromARGB(80, 0, 188, 212),
    hasSsh: true,
    etherchannelLimit: 0,
    defaultInterfaces: () => [
      Port(name: "GigabitEthernet 0/0/0"),
  ...
  static final c1000 = DevicePreset(
    id: 18,
    name: 'Catalyst 1000',
    sku: 'Catalyst 1000',
    category: NetDeviceCategory.Switch,
    color: const Color.fromARGB(80, 139, 195, 74),
    hasSsh: true,
    etherchannelLimit: 8,
    defaultInterfaces: () =>
        List.generate(
          24,
          (i) => Switchport(name: "GigabitEthernet 1/0/${i + 1}"),
        ) +
        [
          Switchport(name: "GigabitEthernet 1/1/1"),
          Switchport(name: "GigabitEthernet 1/1/2"),
          Switchport(name: "GigabitEthernet 1/1/3"),
          Switchport(name: "GigabitEthernet 1/1/4"),
        ],
    defaultConfig: () => {
      'vlans': [
        {
  ...
  static final fpr1010asa = DevicePreset(
    id: 19,
    name: 'Fpr 1010 ASA',
    sku: 'FPR-1010',
    category: NetDeviceCategory.Firewall,
    color: const Color.fromARGB(80, 255, 87, 34),
    hasSsh: true,
    etherchannelLimit: 0,
    defaultInterfaces: () => [
      Port(name: "Management 1/1"),
      Port(name: "GigabitEthernet 1/1"),
      Port(name: "GigabitEthernet 1/2"),
      Port(name: "GigabitEthernet 1/3"),
      Port(name: "GigabitEthernet 1/4"),
      Port(name: "GigabitEthernet 1/5"),
      Port(name: "GigabitEthernet 1/6"),
      Port(name: "GigabitEthernet 1/7"),
      Port(name: "GigabitEthernet 1/8"),
    ],
    defaultConfig: () => {'domain_lookup': false},
    capabilities: [
      'ospf',
    ...
    lockedInterfacePatterns: const ['Management 1/1'],
    lockedInterfaceReason: 'Reserved for management access',
  );
  ...
  /// Get the color for a given SKU string or preset name
  static Color? colorBySku(String skuOrName) {
    for (final p in all) {
      if (p.sku == skuOrName || p.name == skuOrName) return p.color;
    }
    return null;
  }
  ...
  static Map<String, List<DevicePreset>> get byCategory => {
    'Switch': [c2950_24, c2950_48, c2960, c1000],
